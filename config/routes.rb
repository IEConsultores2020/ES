Rails.application.routes.draw do
  ...
  resources :saleheaders do
    member do
      get 'show_saledetails' => 'saleheaders#show_saledetails'       
    end
  end
  ...
  resources :graficos
  resources :outkardexes
  resources :inkardexes 
  ...
  resources :rotacion_inventarios
  ...
  resources :articulos do
    ...
    collection { post :import }  
    collection { get :rotacion_inventarios } 
    
    member do
      get 'show_inkardexes' => 'articulos#show_inkardexes'       
    end
  end
